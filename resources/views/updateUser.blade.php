         ...
         <form method="post" action="/users/{{$user->User_id}}">
          ...
          <div class="mb-3">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="Gender" id="male" value="m" <?php echo ($user['Jenis_kelamin'] == "m") ? 'checked' :'';?>>
              <label class="form-check-label" for="male">
                Laki-laki
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="Gender" id="female" value="f" <?php echo ($user['Jenis_kelamin'] == "f") ? 'checked' :'';?>>
          ...
          <div class="mb-3">
            ...
            <div class="form-floating">
              <textarea class="form-control" placeholder="Masukkan deskripsi user" id="userdesc" name="userdesc" value="{{$user->User_desc}}"></textarea>
