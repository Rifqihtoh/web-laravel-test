...
<html lang="en">
  <head>
    ...
    <title>Form update organizer</title>
  </head>
  <body>
   ...
   <div class="container">
     <div class="row">
       <div class="col-6">
         <h1 class="mt-3">Form update organizer</h1>
         <form method="post" action="/organizers/{{$organizer->Org_id}}">
          @csrf
          @method('PUT')
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control @error('Org_password') is-invalid @enderror" id="Password" placeholder="masukkan password" name="Org_password" value="{{$organizer->Org_password}}">
            @error('Org_password')
              <div class="invalid-feedback">
          ...
          <div class="mb-3">
            ...
            <div class="form-floating">
              <textarea class="form-control" placeholder="Masukkan deskripsi user" id="userdesc" name="Org_description" value="{{$organizer->Org_description}}"></textarea>
